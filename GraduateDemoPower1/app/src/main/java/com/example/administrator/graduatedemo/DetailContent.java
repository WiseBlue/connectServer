...
public class DetailContent extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        imageview1 = (ImageView) findViewById(R.id.imgview5);
        ...
        //Log.i("1213","我是"+text);
        buff = intent.getByteArrayExtra("picture");
...
//标识该消息的来源应用，值为应用名称+AppId。
   ...
   mTencent.shareToQQ(this, bundle, listener);*/
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent1=new Intent(DetailContent.this,MainActivity.class);
